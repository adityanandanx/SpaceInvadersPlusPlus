...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/SpaceInvaderd
...
ifeq ($(config),profile64)
  ...
  TARGETDIR  = ../../../bin
  TARGET     = $(TARGETDIR)/SpaceInvaderp
...
$(OBJDIR)/SpaceInvader.o: ../../../src/SpaceInvader.cpp
	@echo $(notdir $<)
